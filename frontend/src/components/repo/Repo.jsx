                                        ...
                                        <div>
                                            {selectedFile.length > 0 && fileContent && fileContent.length > 0 ? (
                                                <div className="d-flex">
                                                    ...
                                                    <div style={{ height: "341.6px", color: "var(--gh-text)", borderLeft: "0.8px solid rgba(110, 118, 129, 0.15)", padding: "1rem", fontSize: "12px", fontWeight: "500", overflowY: "auto", whiteSpace: "pre-wrap" }}>
                                                        {fileContent}
                                                    </div>
                                                </div>
                                            ) : (
