                                        ...
                                        <>
                                            ...
                                            <div className="modal fade" id="staticBackdrop2" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                <div className="modal-dialog modal-dialog-centered">
                                                    <div className="modal-content" style={{ backgroundColor: "var(--gh-panel)", color: "var(--gh-text)", border: "1px solid var(--gh-border)" }}>
                                                        <div className="modal-header py-3 px-4" style={{ borderBottom: "0.8px solid var(--gh-border)" }}>
                                                            <h1 className="modal-title fs-6 fw-bold" id="staticBackdropLabel">Edit Repo</h1>
                                                        </div>
                                                        <div className="modal-body px-4">
                                                            <form onSubmit={saveChanges} className="edit-repo-form">
                                                                ...
                                                                <span className="modal-footer px-4 pe-0" style={{ borderTop: "0" }}>
                                                                    <button type="button" className="btn btn-secondary fw-semibold px-3" data-bs-dismiss="modal">Cancel</button>
                                                                    <button type="submit" className="btn fw-semibold px-4" style={{ backgroundColor: "var(--gh-green)", color: "var(--gh-text)", border: "1px solid var(--gh-green)" }}>Save</button>
                                                                </span>
                                                            </form>
                                                        </div>
                                                    </div>
                                            ...
                                            <div className="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                <div className="modal-dialog modal-dialog-centered">
                                                    <div className="modal-content" style={{ backgroundColor: "var(--gh-panel)", color: "var(--gh-text)", border: "1px solid var(--gh-border)" }}>
                                                        <div className="modal-header py-3 px-4" style={{ borderBottom: "0.8px solid var(--gh-border)" }}>
                                                            <h1 className="modal-title fs-6 fw-bold" id="staticBackdropLabel">Delete Repo</h1>
                                                        </div>
                                                        <div className="modal-body px-4">
                                                            Are you sure you want to delete your repo?
                                                        </div>
                                                        <div className="modal-footer px-4" style={{ borderTop: "0" }}>
                                                            <button type="button" className="fw-semibold px-3" data-bs-dismiss="modal">Cancel</button>
                                                            <button type="button" className="btn fw-semibold px-3" data-bs-dismiss="modal" onClick={() => deleteRepo(repo._id)} style={{ backgroundColor: "var(--gh-danger)", color: "var(--gh-text)", border: "1px solid var(--gh-danger)" }}>Delete</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="modal fade" id="staticBackdrop3" data-bs-backdrop="static" data-bs-keyboard="false" tabIndex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                            <div className="modal-dialog modal-dialog-centered">
                                                <div className="modal-content" style={{ backgroundColor: "var(--gh-panel)", color: "var(--gh-text)", border: "1px solid var(--gh-border)" }}>
                                                    <div className="modal-header py-3 px-4" style={{ borderBottom: "0.8px solid var(--gh-border)" }}>
                                                        <h1 className="modal-title fs-6 fw-bold" id="staticBackdropLabel">Create issue</h1>
                                                    </div>
                                                    <div className="modal-body px-4">
                                                        <form onSubmit={handleIssueSubmit} className="edit-repo-form">
                                                            ...
                                                            <span className="modal-footer p-0" style={{ borderTop: "0" }}>
                                                                <button type="button" className="btn btn-secondary fw-semibold px-4" data-bs-dismiss="modal">Cancel</button>
                                                                <button type="submit" className="btn fw-semibold px-4" style={{ backgroundColor: "var(--gh-green)", color: "var(--gh-text)", border: "1px solid var(--gh-green)" }}>Add</button>
                                                            </span>
                                                        </form>
                                                    </div>
                                                </div>
                                    ...
                                    <div className='files-heading'>
                                        ...
                                        {fileContent && fileContent.length > 0 && selectedFile.length > 0 ? (
                                            <>
                                                ...
                                                <div className="modal fade" id="editFileModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                    <div className="modal-dialog modal-dialog-centered">
                                                        <div className="modal-content" style={{ backgroundColor: "var(--gh-panel)", color: "var(--gh-text)", border: "1px solid var(--gh-border)" }}>
                                                            <div className="modal-header py-3 px-4" style={{ borderBottom: "0.8px solid var(--gh-border)" }}>
                                                                <h1 className="modal-title fs-6 fw-bold" id="staticBackdropLabel">Edit {selectedFile}</h1>
                                                            </div>
                                                            <div className="modal-body px-4">
                                                                <form className="edit-repo-form">
                                                                    ...
                                                                    <span className="modal-footer" style={{ borderTop: "0", paddingRight: "0" }}>
                                                                        <button type="button" className="btn btn-secondary fw-semibold px-3 cancel" data-bs-dismiss="modal" onClick={() => setToBeFileContent(fileContent)}>Cancel</button>
                                                                        <button type="button" className="btn fw-semibold px-3" id='editFileBtn' style={{ backgroundColor: "var(--gh-green)", color: "var(--gh-text)", border: "1px solid var(--gh-green)" }} onClick={handlePassModalOpen}>Save</button>
                                                                    </span>
                                                                </form>
                                                            </div>
                                                        </div>
                                                ...
                                                <div className="modal fade" id="PasswordModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                    <div className="modal-dialog modal-dialog-centered">
                                                        <div className="modal-content" style={{ backgroundColor: "var(--gh-panel)", color: "var(--gh-text)", border: "1px solid var(--gh-border)" }}>
                                                            <div className="modal-header py-3 px-4" style={{ borderBottom: "0.8px solid var(--gh-border)" }}>
                                                                <h1 className="modal-title fs-6 fw-bold" id="staticBackdropLabel">Password Verification</h1>
                                                            </div>
                                                            <div className="modal-body px-4">
                                                                <form onSubmit={handleConfirmFileUpdateClick} className="edit-repo-form">
                                                                    ...
                                                                    <span className="modal-footer" style={{ borderTop: "0", paddingRight: "0" }}>
                                                                        <button type="button" className="btn btn-secondary fw-semibold px-3 cancel" data-bs-dismiss="modal">Cancel</button>
                                                                        <button type="submit" className="btn fw-semibold px-3" style={{ backgroundColor: "var(--gh-green)", color: "var(--gh-text)", border: "1px solid var(--gh-green)" }}>Save</button>
                                                                    </span>
                                                                </form>
                                                            </div>
                                                        </div>
                                        ...
                                        <div>
                                            {selectedFile.length > 0 && fileContent && fileContent.length > 0 ? (
                                                ...
                                                <table className="table table-hover">
                                                    <tbody>
                                                        {files.map((file) => (
                                                            <tr className="d-flex w-100 justify-content-between" key={file.path}>
                                                                <th scope="row">
