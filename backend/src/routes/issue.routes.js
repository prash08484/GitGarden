...
import { authorizeIssueAccess, authorizeRepositoryExists } from '../middlewares/autho.middleware.js';

const issueRouter = express.Router();


issueRouter.post('/createIssue/:id', authenticate, authorizeRepositoryExists, createIssue);
